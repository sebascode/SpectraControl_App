...
<!-- TODO: drop screenshots in docs/screenshots/ and link them here.
     Suggested set: home.png (entertainment zones), settings.png (settings drawer),
     configurator.png (light positions editor). -->
